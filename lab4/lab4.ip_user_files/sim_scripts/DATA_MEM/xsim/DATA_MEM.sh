...
#
# Script generated by Vivado on Thu Apr 11 20:43:54 CST 2024
...
# script info
echo -e "DATA_MEM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DATA_MEM xil_defaultlib.DATA_MEM xil_defaultlib.glbl -log elaborate.log
}
