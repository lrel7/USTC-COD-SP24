...
#
# Script generated by Vivado on Sun Apr 14 00:11:40 CST 2024
...
# script info
echo -e "INST_MEM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot INST_MEM xil_defaultlib.INST_MEM xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/vlab/vivado/Xilinx/Vivado/2023.1/data/xsim"
  fi
