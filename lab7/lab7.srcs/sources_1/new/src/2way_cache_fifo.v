...
module TwoWayCacheFIFO #(
    ...
    always @(posedge clk or negedge rstn) begin
        if (~rstn) begin
            ...
            cache_wes_buf <= (&r_valids) ? first_in[w_index] : (~r_valids & (-(~r_valids)));
        end
    end
    ...
    /* Write back */
    assign write_back = r_valids & r_dirtys & first_in[w_index];
    ...
    /* Pseudo LRU */
    genvar i;
    reg [1 : 0] first_in[0 : SET_NUM - 1];  // 01: way0 first in, 10: way1 first in
    /* Reset */
    generate
